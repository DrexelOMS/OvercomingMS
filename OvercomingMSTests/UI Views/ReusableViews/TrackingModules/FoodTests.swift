...
class FoodTests: XCTestCase {
    ...
    func testIsFoodGood(){
        main.SatFats = 2
        XCTAssertTrue(main.isFoodGood(food: main) == RecommendedLevel.Bad)
        main.SatFats = 0
        main.Categories = "Dairy"
        XCTAssertTrue(main.isFoodGood(food: main) == RecommendedLevel.Bad)
        main.Categories = ""
        main.Ingredients = "beef"
        XCTAssertTrue(main.isFoodGood(food: main) == RecommendedLevel.Bad)
        main.Ingredients = ""
        XCTAssertTrue(main.isFoodGood(food: main) == RecommendedLevel.Caution)

        main.Ingredients = "lettuce"
        main.Categories = "Salad"
        XCTAssertTrue(main.isFoodGood(food: main) == RecommendedLevel.Good)

    }
    
    func testGetVeganPhrases(){
        XCTAssertTrue(main.getVeganPhrases() == veganPhrases)
